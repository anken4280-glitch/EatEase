            ...
            <div className="suggestion-card featured">
              ...
              <div className="card-header">
                ...
                <span className="cuisine-badge">
                  {topSuggestion.restaurant.cuisine}
                </span>
              </div>
              ...
              <div className="suggestion-details">
                <div className="detail-row">
                  ...
                  <span
                    className={`value status-${topSuggestion.restaurant.status}`}
                  >
                    {topSuggestion.restaurant.crowdLevel} (
                    {topSuggestion.restaurant.occupancy}%)
                  </span>
                </div>
                <div className="detail-row">
                  <span className="label">Wait Time:</span>
                  <span className="value">
                    {topSuggestion.restaurant.waitTime} minutes
                  </span>
                </div>
                <div className="detail-row">
                  <span className="label">Rating:</span>
                  <span className="value">
                    ⭐ {topSuggestion.restaurant.rating}/5
                  </span>
                </div>
              </div>
              ...
              <div className="alternative-cards">
                {suggestions.slice(1, 4).map((suggestion, index) => (
                  <div
                    ...
                    className="suggestion-card alternative"
                  >
