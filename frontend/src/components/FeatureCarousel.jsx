  ...
  return (
    <div className="feature-carousel">
                ...
                <div className="slide-content">
                  ...
                  <div className="slide-text">
                    ...
                    <div className="slide-meta">
                      <span className="restaurant">🏪 {feature.restaurant}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="carousel-actions">
        <button className="action-btn save-btn">💾 Save Deal</button>
        <button className="action-btn share-btn">📤 Share</button>
        <button className="action-btn view-btn">👀 View Restaurant</button>
      </div>
    </div>
  );
}
